...
export default function FilmDirectorRoadmap() {
  ...
  useEffect(() => {
    ...
    // remove the event listener when the component is unmounte
  ...
  return (
    ...
    <div className='hidden md:flex  font-roboto flex-row gap-[2vw] '>
      ...
      <div className='md:w-auto w-full   font-bold flex flex-col gap-[1.5vw] '>
        ...
        <button id="WHISTLING" className='w-[7.5vw] h-[2.2vw] top-[31.3vw] left-[3.3vw] absolute' onClick={toggleMenu}/>
        ...
        <button id="UG" className='w-[6.5vw] h-[3.1vw] rounded-[1.5vw]  top-[36vw] left-[23.2vw] absolute cursor-default' />
        ...
        <button id="UK" className='w-[8vw] h-[3.1vw] rounded-[1.5vw]  top-[29.5vw] left-[49.4vw] absolute' onClick={toggleMenu}/>
        ...
        <button id="Others" className='w-[6.5vw] h-[3vw] rounded-[1.5vw]  top-[53.3vw] left-[43.5vw] cursor-default absolute' />

        <button id="JET" className='w-[8vw] h-[3.5vw]  top-[63vw] left-[22.5vw] absolute' onClick={toggleMenu}/>
        <button id="PG" className='w-[8.9vw] h-[2.9vw] rounded-[1.5vw]  top-[69.7vw] left-[22vw] absolute' onClick={toggleMenu}/>
        <button id="LastStep" className='w-[8.9vw] h-[2.9vw] rounded-[1.5vw]  top-[74.8vw] left-[22vw] cursor-default absolute' />

        <button id="internship" className='w-[8.7vw] h-[2.9vw] cursor-default top-[82.5vw] left-[22.1vw] absolute' />
        <button id="portfolio" className='w-[8.7vw] h-[2.9vw] cursor-default top-[82.5vw] left-[11.5vw] absolute' />
        <button id="teamCollaboration" className='w-[8.7vw] cursor-default h-[2.9vw]  top-[82.5vw] left-[33vw] absolute' />
        <button id="job" className='w-[8vw] h-[3.8vw] cursor-default top-[91.5vw] left-[22.5vw] absolute' />
        </div>
      </div>
