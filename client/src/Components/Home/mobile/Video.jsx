...
<div className="w-[22.688rem] relative text-[1rem] leading-[150%] font-roboto text-justify inline-block">We are trying to bridge the gap of information and guidance between and your potential and opportunities. We provide narrowed road maps and detailed career paths, personalized guidance from alumni and mentors, and a supportive community to help you succeed.</div>
</div>
<div className="w-[22.25rem] h-[3.563rem] flex flex-col items-start justify-start gap-[0.694rem] text-[0.694rem] text-neutral-dark-gray font-roboto">
...
<div className="rounded-[20.14px] bg-darkslategray flex flex-row items-center justify-center py-[0.521rem] px-[1.042rem] text-white border-[0.7px] border-solid border-darkslategray">
<div className="relative leading-[150%]">Sign up</div>
</div>
</div>
<div className="self-stretch relative text-[0.521rem] leading-[150%] text-black">{`By clicking Sign Up you're confirming that you agree with our `}
