...
<div className="self-stretch relative text-[1rem] leading-[150%]">Our platform connects you with knowledgeable alumni and mentors who provide personalized guidance in various fields. Benefit from their expertise and experience to navigate your career path with confidence.</div>
</div>
</div>
...
<div className="self-stretch relative text-[0.875rem] leading-[150%]">Tap into the expertise of our alumni and mentors to gain valuable insights and advice.</div>
</div>
<div className="flex-1 flex flex-col items-start justify-start gap-[0.32rem]">
<div className="self-stretch relative leading-[120%]">Support</div>
<div className="self-stretch relative text-[0.875rem] leading-[150%]">Our community is always available to provide support and assistance whenever you need it.</div>
</div>
</div>
</div>
<div className="flex flex-row items-center justify-center pt-[0.64rem] px-[0rem] pb-[0rem] gap-[0.96rem] text-left text-[0.64rem] text-white">
<div className="w-[4.201rem] rounded-[27.53px] bg-darkslategray box-border flex flex-row items-center justify-center py-[0.5rem] px-[0.938rem] border-[0.6px] border-solid border-black">
