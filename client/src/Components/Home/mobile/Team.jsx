...
<div className="self-stretch relative text-[1rem] leading-[150%]">At our platform, we provide you with narrowed road maps and detailed career paths to help you navigate your chosen field. Our community of alumni and mentors are always available to offer personalized guidance and support. Stay updated with the latest news and reminders in your field of interest.</div>
</div>
</div>
<div className="w-[22.688rem] flex flex-col items-center justify-start gap-[0.938rem] text-[2rem]">
...
<div className="w-[6.438rem] rounded-[38px] bg-darkslategray box-border h-[2.375rem] flex flex-row items-center justify-center py-[0.5rem] px-[0.938rem] border-[1px] border-solid border-darkslategray">
