...
export default function Expertise(){
  	return (
		...
		justify-start py-[3.75rem] px-[4rem] box-border text-center text-[1rem] text-black font-roboto">
					...
					<div className="self-stretch flex flex-col items-start justify-start gap-[2rem]">
						...
						<div className="self-stretch flex flex-row items-start justify-start py-[0.5rem] px-[0rem] gap-[1.5rem] text-left text-[2.875rem]">
							<div className="flex-1 flex flex-col items-start justify-start gap-[0.5rem]">
								...
								<div className="self-stretch relative text-[1rem] leading-[150%]">Tap into the expertise of our alumni and mentors to 
								gain valuable insights and advice.</div>
							</div>
							<div className="flex-1 flex flex-col items-start justify-start gap-[0.5rem]">
								<div className="self-stretch relative leading-[120%]">Support</div>
								<div className="self-stretch relative text-[1rem] leading-[150%]">Our community is always available to provide support
