...
export default function Join() {
  return (
    <div className="w-full relative overflow-hidden flex flex-col items-center justify-start py-[3.75rem] px-[4rem] box-border gap-[3.75rem] text-center text-[1rem] text-black font-roboto">
    ...
    <div className="self-stretch relative text-[1.125rem] leading-[150%]">At our platform, we provide you with narrowed road maps and detailed career paths to help you navigate your chosen field. Our community of alumni and mentors are always available to offer personalized guidance and support. Stay updated with the latest news and reminders in your field of interest.</div>
    </div>
    </div>
    ...
    <div className="self-stretch relative text-[1rem] leading-[150%]">Our platform offers narrowed road maps and detailed career paths to guide you towards success in your chosen field.</div>
    </div>
    </div>
    <div className="flex-1 flex flex-col items-center justify-start gap-[1.5rem]">
    <div className="w-[3rem] relative h-[3rem] overflow-hidden shrink-0" />
    ...
    <div className="self-stretch relative text-[1rem] leading-[150%]">Get personalized guidance and support from our community of alumni and mentors who are experts in their respective fields.</div>
    </div>
    </div>
    <div className="flex-1 flex flex-col items-center justify-start gap-[1.5rem]">
    <div className="w-[3rem] relative h-[3rem] overflow-hidden shrink-0" />
    ...
    <div className="self-stretch relative text-[1rem] leading-[150%]">Join our community of like-minded individuals who are always available to help and support you on your journey.</div>
    </div>
    </div>
    </div>
    <div className="flex flex-row items-center justify-start pt-[1rem] px-[0rem] pb-[0rem] gap-[1.5rem] text-left text-[1rem] text-white">
    <div className="w-[6.875rem] rounded-[38px] bg-darkslategray box-border flex flex-row items-center justify-center py-[0.75rem] px-[1.5rem] border-[1px] border-solid border-darkslategray">
