...
<img className="self-stretch flex-1 relative max-w-full overflow-hidden max-h-full object-cover" alt="" src="Placeholder / Image.png" />
<img className="w-[40rem] relative h-[26.625rem] object-cover" alt="" src="Placeholder / Image.png" />
</div>
